...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final String TAG = com.github.lvp4b.firebase.HomeActivity.class.getSimpleName();
    ...
    public void deleteProfile(View view) {
        ...
        if (user != null) {
            mFirebaseDatabase.child(userId).removeValue().addOnSuccessListener(task -> {
                logout(view);
            });
        }
    }
